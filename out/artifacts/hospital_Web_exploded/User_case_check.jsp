...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="CaseCheck.action"
       title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <form class="layui-form x-center" action="CaseCheck.action" style="width:500px">
    ...
    <xblock><span class="x-right" style="line-height:25px">共有数据：${count}条</span>
        ...
        <div
            ...
            <a href="CaseCheck.action?currentPage=${currentPage-1}&searchWords=${searchWords}">
