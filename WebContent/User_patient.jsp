                ...
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    <div class="layui-input-inline" style="width:400px">
                      <input type="text" name="searchWords" value="${searchWords}"  placeholder="搜索病人名称" autocomplete="off" class="layui-input">
                    </div>
            ...
            <table class="layui-table">
                ...
                <s:iterator id="list" value="upb">
                    ...
                    <tr>
                        ...
                        <td><u style="cursor:pointer" onclick="user_management_show('${name}','user_patient_show.jsp?name=${name}&id=${id}&sex=${sex}&age=${age}&phone=${phone}&email=${email}&nurse=${nurse}&doctor=${doctor}&cure=${cure}','10001','360','400')">${name}</u></td>
                        <td >
                            ${sex}</td>
                        <td >
                            ${age}</td>
                        ...
                        <td class="td-manage">
                            ...
                            <a style="text-decoration:none"  onclick="user_management_password('修改密码','user_password.jsp?id=${id}&type=病人','10001','600','400')"
