...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav" lay-filter="">
                <li class="layui-nav-item"><img src="images/0.jpg" class="layui-circle"
                                                style="border: 2px solid #A9B7B7;" width="35px"
                                                alt=""></li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><%=request.getSession().getAttribute("username") %>
                    </a>
            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                ...
                <li class="layui-nav-item">
                    <a class="javascript:;" href="javascript:;"
                       _href="Medicine.action?grade=<%=grade%>&name=<%=request.getSession().getAttribute("username") %>">
                        <i class="layui-icon" style="top: 3px;">&#xe612;</i><cite><%
                        if (!grade.equals("3")) {
                            out.print("药品管理");
                        } else {
                            out.print("查看药品");
                ...
                <li class="layui-nav-item">
                    <a class="javascript:;" href="javascript:;"
                       _href="Case.action?grade=<%=grade%>&name=<%=request.getSession().getAttribute("username") %>">
                        <i class="layui-icon" style="top: 3px;">&#xe612;</i><cite><%
                        if (!grade.equals("3")) {
                            out.print("病历管理");
                        } else {
    ...
    <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab"
         lay-allowclose="true">
