...
<html>
    ...
    %>
        <div class="x-nav">
            ...
            <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="Medicine.action?grade=<%=grade%>&name=<%=name%>" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a>
        </div>
        <div class="x-body">
          <form class="layui-form x-center" action="" style="width:500px">
            ...
            <xblock>
            <% if(!grade.equals("3")){ %>      
            <button class="layui-btn" onclick="user_management_add('添加病例','PatientId.action?type=medicine','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
            <%} %>
            ...
            <table class="layui-table">
                ...
                <s:iterator id="list" value="amb">
                    ...
                    <tr>
                        ...
                        <% if(grade.equals("1")){ %>
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="user_management_edit('编辑','user_medicine_edit.jsp?id=${id}&text=${name}','4','','510')"
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="DeleteMedicine.action?id=${id}" onclick="member_del(this,'1')" 
